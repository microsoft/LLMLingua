...
class LLMLingua2Tester(unittest.TestCase):
    ...
    COMPRESSED_SINGLE_CONTEXT_PROMPT = "John: thinking project need make changes. want project succeed? consider revising timeline.\n\n Sarah agree John. be realistic. timeline too tight.? extend."
    ...
    def test_general_compress_prompt(self):
        ...
        self.assertEqual(compressed_prompt["compressed_tokens"], 156)
        self.assertEqual(compressed_prompt["ratio"], "3.0x")
        self.assertEqual(compressed_prompt["rate"], "33.6%")
        ...
        self.assertEqual(compressed_prompt["compressed_tokens"], 851)
        self.assertEqual(compressed_prompt["ratio"], "9.9x")
        self.assertEqual(compressed_prompt["rate"], "10.1%")
